                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    @else
                                        <img src="{{ asset('storage/img-produk/') }}" class="foto-preview" width="100%">
                                    @endif
                                    <p></p>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="kategori_id" class="form-control @error('kategori_id') is-invalid @enderror">
                                        ...
                                        @foreach ($kategori as $row)
                                            <option value="{{ $row->id }}" {{ old('kategori_id', $edit->kategori_id) == $row->id ? 'selected' : '' }}>{{ $row->nama_kategori }}</option>
                                        @endforeach
                                    </select>
                                    @error('kategori_id')
                                        <span class="invalid-feedback alert-danger" role="alert">{{ $message }}</span>
