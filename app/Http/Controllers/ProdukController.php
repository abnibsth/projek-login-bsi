...
class ProdukController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->file('foto')) { 
            ...
            $thumbnailSm = 'thumb_sm_' . $originalFileName; ImageHelper::uploadAndResize($file, $directory, $thumbnailSm, 100, 110); 
// Simpan nama file asli di database $validatedData['foto'] = $originalFileName; 
        } 
